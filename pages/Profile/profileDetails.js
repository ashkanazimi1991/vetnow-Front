...
const DetailsId = ({data , tokenCookie}) => {
  ...
  const [modal , setMoadl] = useState({
    ...
    is_Job_Modal: false,
    is_State_Modal: false,
    is_City_Modal: false,
    is_address_Modal: false,
    is_phone_number_Modal: false,
  })
  ...
  //set user extra information state when user change the information
  ...
  const fileuploadHandler = async (event) =>{
    if(event.target.name === "national_code_image"){
        setUserInfo({...userInfo , national_code_image: URL.createObjectURL(event.target.files[0])})
        setPhoto(event.target.files[0])
    }else if(event.target.name === "Incubation_license"){
        setUserInfo({...userInfo ,Incubation_license: URL.createObjectURL(event.target.files[0])})
        setPhoto1(event.target.files[0])
    }else if(event.target.name === "other"){
        setUserInfo({...userInfo ,other: URL.createObjectURL(event.target.files[0])})
...
const submitHandler = async (event) =>{
  ...
  userInfo.national_code_image  && photo && Form_Data.append('national_code_image' , photo , photo.name)
            ...
            <section className={styles.User_Info_Details_Box}>
              <section className={styles.Header_User_Info_Box}>
                ...
                <section className={styles.User_Info_Details_field}>
                  ...
                  <section style={{borderTopLeftRadius: '8px'}} className={styles.User_Info_Details_field_Grid}>
                    <p>کد ملی</p>
                    <div className={styles.User_Info_Details_field_Flex}>
                      <p>{data.national_code}</p>
                      <i onClick={(() => setMoadl({...modal , is_national_code_Modal: true}))} className="fas fa-edit"></i>
                      <Modal
                        
                        isOpen={modal.is_national_code_Modal}
                         ariaHideApp={false}
                        style={customStyles}
                      ...
                      >
                        <div className={styles.Header_Modal}>
                          <p style={{margin: '0'}}>ثبت اطلاعات شناسایی</p>
                          <button onClick={() => Modal_close_handler('is_national_code_Modal')} className={styles.Header_Modal_Close}><i className="fas fa-times"></i></button>
                        </div>
                        <hr />
                        <div style={{textAlign: 'right' , marginTop: '10%' , fontFamily: 'sansiran'}}>
                        ...
                        <form onSubmit={submitHandler} className={styles.Header_Modal_Form}>
                          <section className={styles.Header_Modal_Flex_One_Item}>
                            <div className={styles.Header_Modal_Inputs}>
                              <label>کد ملی</label>
                              <input onChange={inputs_Onchange_Handler} style={{width: '100%'}} defaultValue={data.national_code} name="national_code" type="number"/>
                            </div>
                          </section>
                          <div className={styles.Header_Modal_Buttons}>
                            <button onClick={() => Modal_close_handler('is_national_code_Modal')} className={styles.Header_Modal_Buttons_Back}>بازگشت</button>
                            <button onClick={() => inputs_Click_Handler(['national_code'])} disabled={is_disable} style={is_disable ? {color: 'grey' , border: '1px solid grey'} : {color: 'rgb(27, 154, 204)' , border: '1px solid rgb(27, 154, 204)'}} className={styles.Header_Modal_Buttons_Submit}>ذخیره</button>
                          </div>
                        </form>
                      </Modal>
                    </div>
                  ...
                  <section className={styles.User_Info_Details_field_Grid}>
                    ...
                    <div className={styles.User_Info_Details_field_Flex}>
                      <p>{data.job}</p>
                      <i onClick={(() => setMoadl({...modal , is_Job_Modal: true}))} className="fas fa-edit"></i>
                      <Modal
                        
                        isOpen={modal.is_Job_Modal}
                        ariaHideApp={false}
                        style={customStyles}
                        contentLabel="national code Modal"
                      >
                        <div className={styles.Header_Modal}>
                          <p style={{margin: '0'}}>ثبت اطلاعات شناسایی</p>
                          <button onClick={() => Modal_close_handler('is_Job_Modal')}  className={styles.Header_Modal_Close}><i className="fas fa-times"></i></button>
                        </div>
                        <hr />
                        <div style={{textAlign: 'right' , marginTop: '10%' , fontFamily: 'sansiran'}}>
                           <p>لطفا شغل را وارد کنید</p>
                        </div>
                        <form onSubmit={submitHandler} className={styles.Header_Modal_Form}>
                          <section className={styles.Header_Modal_Flex_One_Item}>
                            <div className={styles.Header_Modal_Inputs}>
                              <label>شغل</label>
                              <input onChange={inputs_Onchange_Handler} style={{width: '100%'}} defaultValue={data.job} name="job" type="text"/>
                            </div>
                          </section>
                          <div className={styles.Header_Modal_Buttons}>
                            <button onClick={() => Modal_close_handler('is_Job_Modal')} className={styles.Header_Modal_Buttons_Back}>بازگشت</button>
                            <button onClick={() => inputs_Click_Handler(['job'])} disabled={is_disable} style={is_disable ? {color: 'grey' , border: '1px solid grey'} : {color: 'rgb(27, 154, 204)' , border: '1px solid rgb(27, 154, 204)'}} className={styles.Header_Modal_Buttons_Submit}>ذخیره</button>
                          </div>
                        </form>
                      </Modal>
                    </div>
                ...
                <form onSubmit={submitHandler} className={styles.Images_Box}>
                    <div className={styles.imageContainer} dir="rtl">
                      {userInfo.national_code_image ?/* <button onClick={fileuploadclickHandler}>upload</button> */ 
                          <div className={styles.national_code_image}>
                              <img
                              src={userInfo.national_code_image}
                              alt="Thumb"
                              />
                              <button id="national_code_imageBtn" onClick={clickHandler}>حدف عکس</button>
                          </div>
                          :
                          <div className={styles.imgBox}>
                              <input style={{display:"none"}} name="national_code_image" onChange={fileuploadHandler} type="file" 
                              ref={firstFileUpload} />
                      ...
                      {userInfo.Incubation_license ?/* <button onClick={fileuploadclickHandler}>upload</button> */ 
                          <div className={styles.Incubation_license}>
                            
                          <img
                              src={userInfo.Incubation_license}
                              alt="Thumb"
                              />
                              <button id="Incubation_licenseBtn" onClick={clickHandler}>حدف عکس</button>
                              
                          </div>
                          :
                          <div className={styles.imgBox}>
                          <input style={{display:"none"}} name="Incubation_license" onChange={fileuploadHandler} type="file" 
                      ...
                      {userInfo.other ?/* <button onClick={fileuploadclickHandler}>upload</button> */ 
                          <div className={styles.other}>
                              <img
                              src={userInfo.other}
                              alt="Thumb"
                              />
                              <button id="otherBtn" onClick={clickHandler}>حدف عکس</button>
                          </div>
                          :
                          <div className={styles.imgBox}>
                          <input style={{display:"none"}} name="other" onChange={fileuploadHandler} type="file" 
                          ref={thridFileUpload} />
